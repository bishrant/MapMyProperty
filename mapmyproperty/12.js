...
(this||window)["webpackJsonp"].registerAbsMids({
	...
	"arcgis-js-api/layers/support/LabelClass":"./node_modules/arcgis-js-api/layers/support/LabelClass.js",
	"arcgis-js-api/layers/support/LabelExpressionInfo":"./node_modules/arcgis-js-api/layers/support/LabelExpressionInfo.js",
	"arcgis-js-api/layers/support/labelUtils":"./node_modules/arcgis-js-api/layers/support/labelUtils.js"
})
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__.dj.c(module.i),exports,__webpack_require__(/*! ../../core/string */ "./node_modules/arcgis-js-api/core/string.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(e,r,n){function t(e){var r;return e?(r=n.replace(e,function(e){return i+'$feature["'+e+'"]'+c}),r=_.test(r)?r.replace(_,""):o+r,r=g.test(r)?r.replace(g,""):r+o,r=r.replace(p,u).replace(a,l)):r='""',r}Object.defineProperty(r,"__esModule",{value:!0});var i="__begin__",c="__end__",p=new RegExp(i,"ig"),a=new RegExp(c,"ig"),_=new RegExp("^"+i,"i"),g=new RegExp(c+"$","i"),o='"',u=o+" + ",l=" + "+o;r.convertTemplatedStringToArcade=t}).apply(null, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
