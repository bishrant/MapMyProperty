...
const pointGraphicsToKML = (graphic, name) => {
    var _g = webMercatorUtils.webMercatorToGeographic(graphic.geometry) as any;
    var _KML = "<Placemark>\n";
