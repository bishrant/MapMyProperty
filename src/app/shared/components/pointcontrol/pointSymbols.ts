...
const getSVGHTML = (id, name: string, color: string) => {
  ...
  switch (name) {
    case 'water':
      bs = `<svg version="1.1" id="${id}"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   ...
   `;
    ...
    case 'square':
      bs = `<svg version="1.1" id="${id}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 50 50" xml:space="preserve">
   <rect stroke="black" stroke-width="1" fill="${color}" x="10.55" y="10.88"  width="30" height="30"/>
   </svg>`;
      break;
    case 'pin':
      bs = `<svg version="1.1" id="${id}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   ...
   `;
      break;
    case 'flag':
      bs = `<svg version="1.1" id="${id}" focusable="false" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
   ...
   <g transform="translate(13.0,22.0) scale(0.100000,-0.100000) rotate(45,0,0)">
     <path  fill="${color}" d="M22.34,88.4l-1-146.12l-157.32-0.48l-1.01-88.67l157.72,0.48l-1.12-163.13l88.67,0.61l1.12,162.73l151.52,0.64
