...
const topo2008 = new ImageryLayer({ url: _tnrisURL + "TOP/TOP08_NC_50cm/ImageServer", id: 'TX TOPO 2008' });
const topo2009 = new ImageryLayer({ url: _tnrisURL + "TOP/TOP09_NC_50cm/ImageServer", id: 'TX TOPO 2009' });
...
const topo2015 = new ImageryLayer({ url: _tnrisURL + "TOP/TOP15_NC_CIR_50cm/ImageServer", id: 'TX TOPO 2015' });
...
const texasBasemaps = ["TX Google 6-inch", "TX NAIP 2018", "TX NAIP 2016", "TX TOPO 2015", "TX NAIP 2014",
...
const texasBasemapsDict = {
  ...
  "TX TOPO 2015": topo2015,
  "TX NAIP 2014": naip2014,
  "TX NAIP 2012": naip2012,
  "TX NAIP 2010": naip2010,
  "TXe TOPO 2009": topo2009,
  "TXw TOPO 2008": topo2008,
  "TX NAIP 2004": naip2004,
  "TX TOPO 1996": topo1996,
}
