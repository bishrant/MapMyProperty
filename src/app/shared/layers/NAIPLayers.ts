...
const naip2010 = new ImageryLayer({ url: _tnrisURL + 'NAIP/NAIP10_NC_CIR_1m/ImageServer', id: 'TX NAIP 2010', ...props } as any);
const naip2012 = new ImageryLayer({ url: _tnrisURL + 'NAIP/NAIP12_NC_CIR_1m/ImageServer', id: 'TX NAIP 2012', ...props } as any);
const naip2014 = new ImageryLayer({ url: _tnrisURL + 'NAIP/NAIP14_NC_CIR_1m/ImageServer', id: 'TX NAIP 2014', ...props } as any);
const topo2015 = new ImageryLayer({ url: _tnrisURL + 'TOP/TOP15_NC_CIR_50cm/ImageServer', id: 'TX TOP 2015', ...props } as any);
const naip2016 = new ImageryLayer({ url: _tnrisURL + 'NAIP/NAIP16_NC_CIR_1m/ImageServer', id: 'TX NAIP 2016', ...props } as any);
const naip2018 = new ImageryLayer({ url: _tnrisURL + 'NAIP/NAIP18_NC_CIR_60cm/ImageServer', id: 'TX NAIP 2018', ...props } as any);
